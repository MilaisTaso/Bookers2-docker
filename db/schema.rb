...
ActiveRecord::Schema.define(version: 2023_01_06_104540) do
  ...
  create_table "book_comments", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.text "comment"
    t.integer "user_id"
    t.integer "book_id"
  ...
  create_table "impressions", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
